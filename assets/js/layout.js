            ...
            <nav class="border-b border-slate-800 bg-slate-950/80 backdrop-blur-xl sticky top-0 z-50">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <a href="https://github.com/sponsors/yourusername" target="_blank" class="flex items-center gap-2 text-xs font-bold text-pink-400 border border-pink-500/30 bg-pink-500/10 px-3 py-1.5 rounded-full hover:bg-pink-500 hover:text-white transition-all">
                    ...
                    <div class="grid md:grid-cols-4 gap-8">
                        ...
                        <div>
                            ...
                            <ul class="space-y-2 text-sm text-slate-500">
                                ...
                                <li><a href="#" class="hover:text-pink-400 transition-colors">Become a Sponsor</a></li>
                                <li><a href="#" class="hover:text-blue-400 transition-colors">Submit a Template</a></li>
                            </ul>
                        </div>
                        <div>
