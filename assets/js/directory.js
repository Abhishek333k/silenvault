...
const silenVaultTools = [
    ...
    },
    {
        ...
        link: "tools/qr_generator.html", tag: "Utility",
        iconColors: "bg-blue-500/10 text-blue-400 group-hover:bg-blue-500",
    ...
    },
    {
        ...
        link: "tools/hash_generator.html", tag: "Security",
        iconColors: "bg-slate-500/10 text-slate-400 group-hover:bg-slate-500",
    ...
    },
    {
        ...
        link: "tools/tone_generator.html", tag: "Audio", /* Fixed routing to match file existence */
    ...
    },
    {
        ...
        link: "tools/controller_tester.html", tag: "Hardware",
        iconColors: "bg-blue-500/10 text-blue-400 group-hover:bg-blue-500",
    ...
    // --- MEDIA OPERATIONS (creator) ---
    {
        ...
        link: "tools/yt_thumbnail.html", tag: "Media",
    ...
    },
    {
        ...
        link: "tools/speech_engine.html", tag: "Audio",
    ...
    },
    {
        ...
        link: "tools/image_converter.html", tag: "Media",
        iconColors: "bg-blue-500/10 text-blue-400 group-hover:bg-blue-500",
    ...
    },
    {
        ...
        link: "tools/exif_remover.html", tag: "Security",
        iconColors: "bg-emerald-500/10 text-emerald-500 group-hover:bg-emerald-500",
    ...
    },
    {
        ...
        link: "tools/image_compressor.html", tag: "Media",
        iconColors: "bg-indigo-500/10 text-indigo-500 group-hover:bg-indigo-500",
