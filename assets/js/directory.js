...
const silenVaultTools = [
    // --- BUSINESS OPERATIONS ---
    {
        ...
        link: "tools/invoice_generator.html", tag: "Finance",
    ...
    },
    {
        ...
        link: "tools/budget_planner.html", tag: "Finance",
    ...
    },
    {
        ...
        link: "tools/loan_calculator.html", tag: "Finance",
    ...
    },
    {
        ...
        link: "tools/salary_tax_calculator.html", tag: "Finance",
        iconColors: "bg-emerald-500/10 text-emerald-500 group-hover:bg-emerald-500",
    ...
    },
    {
        ...
        link: "tools/gst_calculator.html", tag: "Finance",
    ...
    },
    {
        ...
        link: "tools/markdown_converter.html", tag: "Code",
    ...
    },
    {
        ...
        link: "tools/jwt_architect.html", tag: "Security",
    ...
    },
    {
        ...
        link: "tools/base64_converter.html", tag: "Code",
    ...
    },
    {
        ...
        link: "tools/json_tool.html", tag: "Data",
    ...
    },
    {
        ...
        link: "tools/unit_converter.html", tag: "Math",
    ...
    // --- HARDWARE DIAGNOSTICS ---
    {
        ...
        link: "tools/keyboard_tester.html", tag: "Hardware",
        iconColors: "bg-emerald-500/10 text-emerald-400 group-hover:bg-emerald-500",
    ...
    },
    {
        ...
        link: "tools/pixel_tester.html", tag: "Display",
        iconColors: "bg-cyan-500/10 text-cyan-400 group-hover:bg-cyan-500",
    ...
    },
    {
        ...
        link: "tools/mic_tester.html", tag: "Audio",
        iconColors: "bg-purple-500/10 text-purple-400 group-hover:bg-purple-500",
    ...
    },
    {
        ...
        link: "tools/touch_tester.html", tag: "Mobile",
    ...
    },
    {
        ...
        title: "Studio Tuner", desc: "Professional digital strobe tuner with DSP noise filtering and presets.",
        link: "tools/pitch_detector.html", tag: "Audio",
    ...
    },
    {
        ...
        title: "Camera Diagnostics", desc: "Studio viewfinder to analyze webcam resolution, framerate, and lens clarity.",
        link: "tools/webcam_tester.html", tag: "Video",
        iconColors: "bg-emerald-500/10 text-emerald-400 group-hover:bg-emerald-500",
    ...
    },
    {
        ...
        link: "tools/sensor_tester.html", tag: "Mobile",
        iconColors: "bg-indigo-500/10 text-indigo-400 group-hover:bg-indigo-500",
    ...
    },
    {
        ...
        link: "tools/controller_tester.html", tag: "Gaming",
        iconColors: "bg-blue-500/10 text-blue-400 group-hover:bg-blue-500",
    ...
    {
        category: "hardware", id: "tone_generator",
        title: "Tone & Frequency Engine", desc: "Generate pure frequencies from 1Hz to 20kHz, sweep ranges, and eject water.",
        link: "tools/tone_generator.html", tag: "Audio",
        iconColors: "bg-cyan-500/10 text-cyan-400 group-hover:bg-cyan-500",
    ...
    },
    {
        ...
        link: "tools/vibration_tester.html", tag: "Mobile",
        iconColors: "bg-purple-500/10 text-purple-400 group-hover:bg-purple-500",
    ...
    // --- CREATOR TOOLS ---
    {
        ...
        link: "tools/yt_thumbnail.html", tag: "",
    ...
    },
    {
        ...
        link: "tools/image_converter.html", tag: "",
        iconColors: "bg-blue-500/10 text-blue-400 group-hover:bg-blue-500",
    ...
    },
    {
        ...
        title: "EXIF Shield", desc: "Scan & remove GPS location data from your photos.",
        link: "tools/exif_remover.html", tag: "",
        iconColors: "bg-emerald-500/10 text-emerald-500 group-hover:bg-emerald-500",
    ...
    },
    {
        ...
        link: "tools/image_compressor.html", tag: "",
        iconColors: "bg-indigo-500/10 text-indigo-500 group-hover:bg-indigo-500",
